  ...
  const SidebarContent = (
    <>
      ...
      <div className="px-3 py-4 border-t border-gray-100 dark:border-gray-800 space-y-1" data-tour="lang-switch">
        ...
        <Link href={isManager(profile.role) ? '/dashboard/settings' : '/rep/settings'} onClick={() => setOpen(false)}
          className="flex items-center gap-2 w-full px-3 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 rounded-xl transition-colors">
