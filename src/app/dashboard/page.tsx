    ...
    <div className="p-8">
      ...
      <div className="card p-6 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 text-center">
          {[
            { label: 'Contacted', value: teamMetrics.businesses_contacted, icon: '\u{1F3E2}' },
            { label: 'Follow-ups', value: teamMetrics.follow_ups, icon: '\u{1F501}' },
            { label: 'Meetings', value: teamMetrics.meetings_booked, icon: '\u{1F4C5}' },
            { label: 'Demos', value: teamMetrics.demos_done, icon: '\u{1F4BB}' },
            { label: 'Proposals', value: teamMetrics.proposals_sent, icon: '\u{1F4C4}' },
            { label: 'Deals', value: teamMetrics.deals_closed, icon: '\u{1F91D}' },
          ].map(item => (
